...
static mqtt_connection_t mqtt_object;
...
wiced_result_t aws_app_init( aws_app_info_t *app_info )
{
    ...
    WPRINT_APP_INFO(("(To return to SSID console screen, hold USER switch for 3 seconds during RESET to clear DCT configuration)\n"));
    ...
    app_info->mqtt_object = &mqtt_object;
