...
{
    .device_name               = (uint8_t*)"BLE Scan", 		  /**< Local device name (NULL terminated) */
    ...
    .ble_advert_cfg =                  /**< BLE advertisement settings */
    {
        ...
        .high_duty_min_interval          = 160,//WICED_BT_CFG_DEFAULT_HIGH_DUTY_ADV_MIN_INTERVAL,          /**< High duty undirected connectable advert minimum advertising interval (default: WICED_BT_CFG_DEFAULT_HIGH_DUTY_ADV_MIN_INTERVAL) */
        .high_duty_max_interval          = 160,//WICED_BT_CFG_DEFAULT_HIGH_DUTY_ADV_MAX_INTERVAL,          /**< High duty undirected connectable advert maximum advertising interval (default: WICED_BT_CFG_DEFAULT_HIGH_DUTY_ADV_MAX_INTERVAL) */
    ...
    .gatt_cfg =                       /**< GATT settings */
    {
         ...
         .max_attr_len     = 720, /**< Maximum attribute length; gki_cfg must have a corresponding buffer pool that can hold this length */
    },
